...
import br.com.sysmanager.facades.Facade_Departamento;
 ...
 * @author Júnior
 */
public class Form_Manter_Departamento extends javax.swing.JDialog {

    private Facade_Departamento facade_departamento = new Facade_Departamento();
    private static int BUTTON = 0;

    public Form_Manter_Departamento(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        open_form();
    }
    ...
    public void open_form(){
        facade_departamento.preencher_jtable_departamento(1, "", null, tableDepartamento);
        Funcoes.desabilitaCampos(panel_dados_departamento);
    ...
    private void initComponents() {
        ...
        panel_dados_departamento = new javax.swing.JPanel();
        ...
        tableDepartamento.setFont(new java.awt.Font("Arial", 0, 12));
        tableDepartamento.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Descrição do Departamento"
            }
        ) {
        ...
        tableDepartamento.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tableDepartamento.setComponentPopupMenu(popupMenu_cargo);
        tableDepartamento.setName("tableDepartamento"); // NOI18N
        tableDepartamento.setRowHeight(20);
        tableDepartamento.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(tableDepartamento);
        tableDepartamento.getColumnModel().getColumn(0).setPreferredWidth(80);
        tableDepartamento.getColumnModel().getColumn(1).setPreferredWidth(350);
        ...
        panel_dados_departamento.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Departamento", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(0, 0, 204))); // NOI18N
        panel_dados_departamento.setName("panel_dados_departamento"); // NOI18N
        ...
        javax.swing.GroupLayout panel_dados_departamentoLayout = new javax.swing.GroupLayout(panel_dados_departamento);
        panel_dados_departamento.setLayout(panel_dados_departamentoLayout);
        panel_dados_departamentoLayout.setHorizontalGroup(
            panel_dados_departamentoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panel_dados_departamentoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panel_dados_departamentoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panel_dados_departamentoLayout.setVerticalGroup(
            panel_dados_departamentoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panel_dados_departamentoLayout.createSequentialGroup()
                .addComponent(codigoLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panel_dados_departamento, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panel_dados_departamento, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );

        tabbedPane_cargo.addTab("Departamento", jPanel2);
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        if(textField_descricao.getText().equals("")){
            ...
            if(BUTTON == 0){
                facade_departamento.setDepartamento(facade_departamento.newInstance());
            }

            facade_departamento.getDepartamento().setDescricao(textField_descricao.getText());

            facade_departamento.getDepartamento_dao().salvar(facade_departamento.getDepartamento());

            facade_departamento.preencher_jtable_departamento(1, "", null, tableDepartamento);
            Funcoes.limpaTela(panel_dados_departamento);
    ...
    private void buttonIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonIncluirActionPerformed
        ...
        textField_descricao.requestFocus();
        Funcoes.habilitaCampos(panel_dados_departamento);
        Funcoes.limpaTela(panel_dados_departamento);
        textField_codigo.setEditable(false);
    ...
    private void buttonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAlterarActionPerformed
        ...
        if(tableDepartamento.getSelectedRow() < 0){
            Funcoes.mensagemAviso("Selecione um registro !");
        }

        else{

            int linhaSelecionada = tableDepartamento.getSelectedRow();

            Integer codigo = Integer.parseInt(String.valueOf(tableDepartamento.getValueAt(linhaSelecionada, 0)));

            facade_departamento.setDepartamento(facade_departamento.getDepartamento_dao().procurar_por_codigo(codigo));
            ...
            textField_codigo.setText(facade_departamento.getDepartamento().getCodigo().toString());
            textField_descricao.setText(facade_departamento.getDepartamento().getDescricao());
    ...
    private void textField_pesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textField_pesquisaKeyReleased
        ...
        if(comboBox_tipoPesquisa.getSelectedIndex() == 0){
            facade_departamento.preencher_jtable_departamento(1, textField_pesquisa.getText(), null, tableDepartamento);
        }

        else if(comboBox_tipoPesquisa.getSelectedIndex() == 1){
            facade_departamento.preencher_jtable_departamento(2, null, textField_pesquisa.getText(), tableDepartamento);
        }
    ...
    private javax.swing.JPanel panel_dados_departamento;
