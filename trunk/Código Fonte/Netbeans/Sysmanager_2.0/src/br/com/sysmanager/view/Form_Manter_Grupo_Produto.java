 ...
 * @author Júnior
 */
public class Form_Manter_Grupo_Produto extends javax.swing.JDialog {

    private Facade_GrupoProduto facade_grupo = new Facade_GrupoProduto();
    private static int BUTTON = 0;

    public Form_Manter_Grupo_Produto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        open_form();
    }
    ...
    public void open_form(){
        facade_grupo.preencher_jtable_grupo(1, "", null, tableGrupoProduto);
        Funcoes.desabilitaCampos(panel_dados_grupo);
    ...
    private void initComponents() {
        ...
        tableGrupoProduto = new javax.swing.JTable();
        ...
        panel_dados_grupo = new javax.swing.JPanel();
        ...
        tableGrupoProduto.setFont(new java.awt.Font("Arial", 0, 12));
        tableGrupoProduto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null},
                {null, null},
                {null, null},
        ...
        tableGrupoProduto.setAutoResizeMode(javax.swing.JTable.AUTO_RESIZE_OFF);
        tableGrupoProduto.setComponentPopupMenu(popupMenu_cargo);
        tableGrupoProduto.setName("tableGrupoProduto"); // NOI18N
        tableGrupoProduto.setRowHeight(20);
        tableGrupoProduto.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(tableGrupoProduto);
        tableGrupoProduto.getColumnModel().getColumn(0).setPreferredWidth(80);
        tableGrupoProduto.getColumnModel().getColumn(1).setPreferredWidth(350);
        ...
        panel_dados_grupo.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Dados do Grupo", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 12), new java.awt.Color(0, 0, 204))); // NOI18N
        panel_dados_grupo.setName("panel_dados_grupo"); // NOI18N
        ...
        javax.swing.GroupLayout panel_dados_grupoLayout = new javax.swing.GroupLayout(panel_dados_grupo);
        panel_dados_grupo.setLayout(panel_dados_grupoLayout);
        panel_dados_grupoLayout.setHorizontalGroup(
            panel_dados_grupoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panel_dados_grupoLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panel_dados_grupoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        panel_dados_grupoLayout.setVerticalGroup(
            panel_dados_grupoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panel_dados_grupoLayout.createSequentialGroup()
                .addComponent(codigoLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panel_dados_grupo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(panel_dados_grupo, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );

        tabbedPane_cargo.addTab("Grupo", jPanel2);
    ...
    private void buttonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSalvarActionPerformed
        ...
        if(textField_descricao.getText().equals("")){
            ...
            if(BUTTON == 0){
                facade_grupo.setGrupo(facade_grupo.newInstance());
            }

            facade_grupo.getGrupo().setDescricao(textField_descricao.getText());

            facade_grupo.getGrupo_dao().salvar(facade_grupo.getGrupo());

            facade_grupo.preencher_jtable_grupo(1, "", null, tableGrupoProduto);
            Funcoes.limpaTela(panel_dados_grupo);
    ...
    private void buttonIncluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonIncluirActionPerformed
        ...
        textField_descricao.requestFocus();
        Funcoes.habilitaCampos(panel_dados_grupo);
        Funcoes.limpaTela(panel_dados_grupo);
        textField_codigo.setEditable(false);
    ...
    private void buttonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonAlterarActionPerformed
        ...
        if(tableGrupoProduto.getSelectedRow() < 0){
            Funcoes.mensagemAviso("Selecione um registro !");
        }

        else{

            int linhaSelecionada = tableGrupoProduto.getSelectedRow();

            Integer codigo = Integer.parseInt(String.valueOf(tableGrupoProduto.getValueAt(linhaSelecionada, 0)));

            facade_grupo.setGrupo(facade_grupo.getGrupo_dao().procurar_por_codigo(codigo));
            ...
            textField_codigo.setText(facade_grupo.getGrupo().getCodigo().toString());
            textField_descricao.setText(facade_grupo.getGrupo().getDescricao());
    ...
    private void textField_pesquisaKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textField_pesquisaKeyReleased
        ...
        if(comboBox_tipoPesquisa.getSelectedIndex() == 0){
            facade_grupo.preencher_jtable_grupo(1, textField_pesquisa.getText(), null, tableGrupoProduto);
        }

        else if(comboBox_tipoPesquisa.getSelectedIndex() == 1){
            facade_grupo.preencher_jtable_grupo(2, null, textField_pesquisa.getText(), tableGrupoProduto);
        }
